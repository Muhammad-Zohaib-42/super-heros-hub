...
"connections": {
"groupAffiliation": "-",
"relatives": "Niki Sanders (Mother), DL Hawkins (Father), Paulette Hawkins (paternal grandmother), Hal Sanders (maternal grandfather), Nana Dawson (Guardian) Nana Dawson (Great-aunt), Monica Dawson (Cousin), Damon Dawson (Cousin)"
},
"images": {
...
"relatives": "Jack Fury (father, deceased); unnamed mother; unnamed stepmother (deceased); Dawn Fury (half-sister); Jake Fury (half-brother); Mikel Fury (son, deceased); Jerry Sapristi (cousin); Tina Sapristi (cousin by marriage); Ernesto, Pietro, Giovanni, Maria, Rosa and Gabriella (1st cousins once removed);"
},
"images": {
